...
<section id="update_identifiers">
	...
	The course identifier mapping can be editted <a href="https://docs.google.com/spreadsheets/d/17gtugoN05aYnWN07Exf6_RpdknlpCfi6a1WSTyJ_z7c/edit#gid=0" target="_blank">here</a><br/><br/>
	Course mapping to clients can be editted <a href="https://docs.google.com/spreadsheets/d/1s01ZBNyTsGScQZFPZNhBDfYACcwXvvaSMiT9yAFHIyc/edit#gid=0" target="_blank">here</a><br/><br/>
...
function update_course_attendance(id) {
	...
	$.get('/api/update_course_attendance.php?id='+id,function(data) {
...
function update_badges(id) {
	...
	$.get('/api/update_badges.php?id='+id,function(data) {
...
function update_access(id) {
	...
	$.get('/api/update_access.php?id='+id,function(data) {
